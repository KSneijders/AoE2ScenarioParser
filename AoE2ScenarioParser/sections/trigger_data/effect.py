...
class Effect(BaseStruct):
    ...
    _flash_unit: int                       = RetrieverRef(ret(_properties), 31)
    ...
    _object2_id: int                       = RetrieverRef(ret(_properties), 36)
    _button_location: int                  = RetrieverRef(ret(_properties), 37)
    _ai_signal: int                        = RetrieverRef(ret(_properties), 38)
    _unknown3: int                         = RetrieverRef(ret(_properties), 39)
    _object_attribute: int                 = RetrieverRef(ret(_properties), 40)
    _variable1_id: int                     = RetrieverRef(ret(_properties), 41)
    _timer_id: int                         = RetrieverRef(ret(_properties), 42)
    _facet: int                            = RetrieverRef(ret(_properties), 43)
    _location_unit_ref: int                = RetrieverRef(ret(_properties), 44)
    ...
    _unit_state: int                       = RetrieverRef(ret(_properties), 50)
    ...
    _variable2_id: int                     = RetrieverRef(ret(_properties), 61)
    ...
    _object2_group: int                    = RetrieverRef(ret(_properties), 68)
    _object2_type: int                     = RetrieverRef(ret(_properties), 69)
