...
class ChangeObjectHp(Effect, HasSelectedUnitsAttribute, CanHoldUnits):
    """
    This effect can be used to modify the current HP of units.
    """
    EFFECT_ID: int = 27
    ...
    """The amount to change the HP by"""

    object_id: UnitInfo | BuildingInfo | HeroInfo | OtherInfo | int = RetrieverRef(Effect._object_id)
    """The type of unit to change HP"""

    source_player: Player | int = RetrieverRef(Effect._source_player)
    """The player whose units will have their HP changed"""

    @property
    def area(self) -> Area:
        """The area in which units will have their HP changed. When not set, units across the entire map have their HP changed"""
        return self._area
