...
class FreezeObject(Effect, HasSelectedUnitsAttribute, CanHoldUnits):
    """
    This effect can be used to 'freeze' units in place by stopping them and setting them to no attack stance.
    """
    EFFECT_ID: int = 22
    ...
    """The type of unit to freeze"""

    source_player: Player | int = RetrieverRef(Effect._source_player)
    """The player whose units will be frozen"""

    @property
    def area(self) -> Area:
        """The area in which units will be frozen. When not set, units across the entire map are frozen"""
        return self._area
