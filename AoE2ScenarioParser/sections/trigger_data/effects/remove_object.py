...
from AoE2ScenarioParser.datasets.trigger_data import ObjectClass, ObjectType, ObjectState
...
class RemoveObject(Effect, HasSelectedUnitsAttribute, CanHoldUnits):
    """
    ...
    unit_state: ObjectState | int = RetrieverRef(Effect._unit_state)
    ...
    def __init__(
        ...
        self.unit_state: ObjectState | int = unit_state
