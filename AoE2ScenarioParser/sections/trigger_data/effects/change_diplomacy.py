...
class ChangeDiplomacy(Effect):
    ...
    diplomacy_state: DiplomacyStance | int = RetrieverRef(Effect._diplomacy_state)
    ...
    def __init__(
        self,
        diplomacy_state: DiplomacyStance | int = -1,
        source_player: Player | int = -1,
        target_player: Player | int = -1,
    ):
        super().__init__()

        self.diplomacy_state: DiplomacyStance | int = diplomacy_state
