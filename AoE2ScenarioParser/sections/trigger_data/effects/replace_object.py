...
class ReplaceObject(Effect):
    ...
    """The type of unit to replace"""

    source_player: Player = RetrieverRef(Effect._source_player)
    """The player whose units will be replaced"""

    target_player: Player = RetrieverRef(Effect._target_player)
    """The player to whom the replaced units will belong"""

    @property
    def area(self) -> Area:
        """The area in which units will be replaced. When not set, units across the entire map are replaced"""
        return self._area
    ...
    """The type of unit that the affected units will be replaced with"""
