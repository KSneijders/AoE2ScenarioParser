...
class DisableObjectDeletion(Effect, HasSelectedUnitsAttribute, CanHoldUnits):
    """
    This effect can be used to prevent the player from deleting units.
    """
    EFFECT_ID: int = 74
    ...
    """The type of unit to disable deletion for"""

    source_player: Player | int = RetrieverRef(Effect._source_player)
    """The player whose units will have deletion disabled"""

    @property
    def area(self) -> Area:
        """The area in which units will have deletion disabled. When not set, units across the entire map have deletion disabled"""
        return self._area
