...
class EnableObjectSelection(Effect, HasSelectedUnitsAttribute, CanHoldUnits):
    """
    This effect can be used to re-enable selection for units that were previously made unselectable.
    """
    EFFECT_ID: int = 71
    ...
    """The type of unit to enable selection for"""

    source_player: Player | int = RetrieverRef(Effect._source_player)
    """The player whose units will have selection re-enabled"""

    @property
    def area(self) -> Area:
        """The area in which units will have selection enabled. When not set, units across the entire map have selection enabled"""
        return self._area
