...
class KillObject(Effect, HasSelectedUnitsAttribute, CanHoldUnits):
    """
    This effect can be used to kill units.
    """
    EFFECT_ID: int = 14
    ...
    """The type of unit to kill"""

    source_player: Player | int = RetrieverRef(Effect._source_player)
    """The player whose units will be killed"""

    @property
    def area(self) -> Area:
        """The area in which units will be killed. When not set, units across the entire map are killed"""
        return self._area
