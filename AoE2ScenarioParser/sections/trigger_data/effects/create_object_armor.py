...
class CreateObjectArmor(Effect, HasSelectedUnitsAttribute, CanHoldUnits):
    """
    This effect can be used to add a new armor class to a type on unit.
    """
    EFFECT_ID: int = 78
    ...
    """The player whose units will have the armor class added"""

    @property
    def area(self) -> Area:
        """The area in which units will have the armor class added. When not set, units across the entire map have the armor class added"""
        return self._area
