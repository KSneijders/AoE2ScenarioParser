...
class HealObject(Effect, HasSelectedUnitsAttribute, CanHoldUnits):
    """
    This effect can be used to restore HP to units.
    """
    EFFECT_ID: int = 34
    ...
    """The type of unit to heal"""

    source_player: Player | int = RetrieverRef(Effect._source_player)
    """The player whose units will be healed"""

    @property
    def area(self) -> Area:
        """The area in which units will be healed. When not set, units across the entire map are healed"""
        return self._area
