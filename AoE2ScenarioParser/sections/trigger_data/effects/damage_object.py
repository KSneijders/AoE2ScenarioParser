...
class DamageObject(Effect, HasSelectedUnitsAttribute, CanHoldUnits):
    """
    This effect can be used to deal a specified amount of damage to units.
    """
    EFFECT_ID: int = 24
    ...
    """The type of unit to damage"""

    source_player: Player | int = RetrieverRef(Effect._source_player)
    """The player whose units will be damaged"""

    @property
    def area(self) -> Area:
        """The area in which units will be damaged. When not set, units across the entire map are damaged"""
        return self._area
