...
class Condition(BaseStruct):
    ...
    static_value_2_4_1_36: int             = Retriever(int32,                 max_ver=Version((2, 2, 1, 37)), default=21)
    static_value_2_4_1_40: int             = Retriever(int32, Version((2, 4, 1, 40)), Version((2, 4, 1, 41)), default=24)
    static_value_2_4_1_42: int             = Retriever(int32, Version((2, 4, 1, 42)), Version((2, 5, 1, 45)), default=25)
    static_value_3_0_1_46: int             = Retriever(int32, Version((3, 0, 1, 46)),                         default=28)
    ...
    unit_ai_action: int                    = Retriever(int32, Version((2, 4, 1, 40)),                         default=-1)
    unknown4: int                          = Retriever(int32, Version((2, 4, 1, 40)),                         default=-1)
    object_state: int                      = Retriever(int32, Version((2, 4, 1, 42)),                         default=-1)
    timer_id: int                          = Retriever(int32, Version((3, 0, 1, 46)),                         default=-1)
    victory_timer_type: int                = Retriever(int32, Version((3, 0, 1, 46)),                         default=-1)
    include_changeable_weapon_objects: int = Retriever(int32, Version((3, 0, 1, 46)),                         default=-1)
    xs_function: str                       = Retriever(str32, Version((2, 4, 1, 40)),                         default="")
    # formatter:on
