...
from binary_file_parser.types import Array32, FixedLenStr, bool32, int32, nt_str32, uint32
...
class FileHeader(BaseStruct):
    ...
    individual_victories_used: bool = Retriever(bool32, max_ver=Version((1, 37)), default = False)
