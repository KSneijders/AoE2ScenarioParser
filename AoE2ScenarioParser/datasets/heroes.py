...
class HeroInfo(Enum):
    ...
    EDWARD_LONGSHANKS = 1669, 358, 1670, False
    GILBERT_DE_CLARE = 1671, 364, 1672, False
    JOHN_THE_FEARLESS = 1673, 359, 1674, False
    PHILIP_THE_GOOD = 1675, 360, 1676, False
    ROBERT_GUISCARD = 1677, 361, 1678, False
    ROGER_BOSSO = 1679, 362, 1680, False
    BOHEMOND = 1681, 357, 1682, False
    LLYWELYN_AP_GRUFFYDD = 1683, 368, 1684, False
    DAFYDD_AP_GRUFFYDD = 1685, 366, 1686, False
    BERNARD_D_ARMAGNAC = 1687, 365, 1688, False
    WARWOLF_TREBUCHET = 1690, 94, 194, False
    WARWOLF_TREBUCHET_PACKED = 1691, 313, 735, False
    JACQUELINE_OF_HAINAUT = 1692, 367, 1328, False
