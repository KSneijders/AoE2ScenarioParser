...
# THIS CODE ORIGINATES FROM THE pantsbuild/pants REPOSITORY (https://github.com/pantsbuild/pants).
# File: https://github.com/pantsbuild/pants/blob/main/src/python/pants/util/ordered_set.py (12/12/21)

"""
An OrderedSet is a set that remembers its insertion order, and a FrozenOrderedSet is one that is also immutable.
...
import itertools
from typing import AbstractSet, Any, Hashable, Iterable, Iterator, MutableSet, Set, TypeVar, cast, Dict
