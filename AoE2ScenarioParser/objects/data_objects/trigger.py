...
class Trigger(AoE2Object):
    ...
    _link_list = [
        RetrieverObjectLink("name", "TriggersPiece", "trigger_data[__index__].trigger_name"),
        RetrieverObjectLink("description", "TriggersPiece", "trigger_data[__index__].trigger_description"),
        RetrieverObjectLink("description_stid", "TriggersPiece", "trigger_data[__index__].description_string_table_id"),
        RetrieverObjectLink("display_as_objective", "TriggersPiece", "trigger_data[__index__].display_as_objective"),
        RetrieverObjectLink("short_description", "TriggersPiece", "trigger_data[__index__].short_description"),
        RetrieverObjectLink("short_description_stid", "TriggersPiece",
                            "trigger_data[__index__].short_description_string_table_id"),
        RetrieverObjectLink("display_on_screen", "TriggersPiece", "trigger_data[__index__].display_on_screen"),
        RetrieverObjectLink("description_order", "TriggersPiece", "trigger_data[__index__].objective_description_order"),
        RetrieverObjectLink("enabled", "TriggersPiece", "trigger_data[__index__].enabled"),
        RetrieverObjectLink("looping", "TriggersPiece", "trigger_data[__index__].looping"),
