...
class ChangeObjectHp (Effect):
    _type_ = EffectType.CHANGE_OBJECT_HP

    quantity: int = RetrieverRef(EffectStruct._quantity)  # type:ignore
    """The amount of HP to be adjusted"""
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        Adjust the HP of all objects that are affected by this effect.

        Args:
            quantity: The amount of HP to be adjusted
