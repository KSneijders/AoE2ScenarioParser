...
class ChangeObjectAttack (Effect):
    _type_ = EffectType.CHANGE_OBJECT_ATTACK

    # Todo: How to solve this: armour_attack_quantity
    # Todo: How to solve this: armour_attack_class
    quantity: int = RetrieverRef(EffectStruct._quantity)  # type:ignore
    """The amount of attack to be adjusted"""
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        Adjust the attack of all objects that are affected by this effect.

        Args:
            quantity: The amount of attack to be adjusted
