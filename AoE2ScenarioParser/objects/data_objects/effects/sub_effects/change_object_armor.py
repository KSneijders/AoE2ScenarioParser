...
class ChangeObjectArmor(Effect):
    _type_ = EffectType.CHANGE_OBJECT_ARMOR
    ...
    """The amount of armor to be adjusted"""
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        Adjust the armor of all objects that are affected by this effect.

        Args:
            quantity: The amount of armor to be adjusted
