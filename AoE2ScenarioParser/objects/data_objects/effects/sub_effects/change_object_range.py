...
class ChangeObjectRange(Effect):
    _type_ = EffectType.CHANGE_OBJECT_RANGE

    quantity: int = RetrieverRef(EffectStruct._quantity)  # type:ignore
    """The amount of range to be adjusted"""
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        Adjust the range of all objects that are affected by this effect.

        Args:
            quantity: The amount of range to be adjusted
