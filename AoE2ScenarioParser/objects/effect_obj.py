...
class EffectObject(AoE2Object):
    ...
    _link_list = [
        ...
        RetrieverObjectLink("display_time", "TriggerPiece",
        ...
        RetrieverObjectLink("location_object_reference", "TriggerPiece",
        ...
        RetrieverObjectLink("object_group", "TriggerPiece",
                            "trigger_data[__index__].effect_data[__index__].object_group"),
        RetrieverObjectLink("object_type", "TriggerPiece",
                            "trigger_data[__index__].effect_data[__index__].object_type"),
        RetrieverObjectLink("instruction_panel_position", "TriggerPiece",
                            "trigger_data[__index__].effect_data[__index__].instruction_panel_position"),
        RetrieverObjectLink("attack_stance", "TriggerPiece",
        ...
        RetrieverObjectLink("enabled_or_victory", "TriggerPiece",
        ...
        RetrieverObjectLink("flash_object", "TriggerPiece",
                            "trigger_data[__index__].effect_data[__index__].flash_object"),
        RetrieverObjectLink("force_research_technology", "TriggerPiece",
                            "trigger_data[__index__].effect_data[__index__].force_research_technology"),
        RetrieverObjectLink("visibility_state", "TriggerPiece",
