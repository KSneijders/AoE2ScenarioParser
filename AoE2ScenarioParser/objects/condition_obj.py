...
class ConditionObject(AoE2Object):
    ...
    _link_list = [
        RetrieverObjectLink("condition_type", "TriggersPiece",
                            "trigger_data[__index__].condition_data[__index__].condition_type"),
        RetrieverObjectLink("amount_or_quantity", "TriggersPiece",
                            "trigger_data[__index__].condition_data[__index__].amount_or_quantity"),
        RetrieverObjectLink("resource_type_or_tribute_list", "TriggersPiece",
                            "trigger_data[__index__].condition_data[__index__]"
                            ".resource_type_or_tribute_list"),
        RetrieverObjectLink("unit_object", "TriggersPiece",
                            "trigger_data[__index__].condition_data[__index__].unit_object"),
        RetrieverObjectLink("next_object", "TriggersPiece",
                            "trigger_data[__index__].condition_data[__index__].next_object"),
        RetrieverObjectLink("object_list", "TriggersPiece",
        ...
        RetrieverObjectLink("technology", "TriggersPiece",
                            "trigger_data[__index__].condition_data[__index__].technology"),
        RetrieverObjectLink("timer", "TriggersPiece", "trigger_data[__index__].condition_data[__index__].timer"),
        RetrieverObjectLink("area_1_x", "TriggersPiece", "trigger_data[__index__].condition_data[__index__].area_1_x"),
        RetrieverObjectLink("area_1_y", "TriggersPiece", "trigger_data[__index__].condition_data[__index__].area_1_y"),
        RetrieverObjectLink("area_2_x", "TriggersPiece", "trigger_data[__index__].condition_data[__index__].area_2_x"),
        RetrieverObjectLink("area_2_y", "TriggersPiece", "trigger_data[__index__].condition_data[__index__].area_2_y"),
        ...
        RetrieverObjectLink("ai_signal", "TriggersPiece", "trigger_data[__index__].condition_data[__index__].ai_signal"),
        RetrieverObjectLink("inverted", "TriggersPiece", "trigger_data[__index__].condition_data[__index__].inverted"),
        RetrieverObjectLink("variable", "TriggersPiece", "trigger_data[__index__].condition_data[__index__].variable"),
        RetrieverObjectLink("comparison", "TriggersPiece",
        ...
        RetrieverObjectLink("xs_function", "TriggersPiece",
                            "trigger_data[__index__].condition_data[__index__].xs_function"),
        RetrieverObjectLink("unit_ai_action", "TriggersPiece",
