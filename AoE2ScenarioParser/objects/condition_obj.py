...
class ConditionObject(AoE2Object):
    ...
    _link_list = [
        ...
        RetrieverObjectLink("technology", "TriggerPiece",
        ...
        RetrieverObjectLink("comparison", "TriggerPiece",
